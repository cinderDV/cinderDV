...
<p align="center">
Estudiante de Ingeniería Civil en Computación e Informática · Desarrollo Web Fullstack & DevOps
</p>
...
- Experiencia con arquitecturas serverless y tradicionales

**DevOps & Infraestructura:**
- Gestión de **servidores on-premise** con despliegues automáticos usando **Coolify**
- Administración de contenedores **Docker** y pipelines CI/CD
- Control de versiones con **Git y GitHub**

---

💡 *Actualmente explorando la intersección entre desarrollo web y DevOps para crear soluciones completas desde el código hasta producción.*
